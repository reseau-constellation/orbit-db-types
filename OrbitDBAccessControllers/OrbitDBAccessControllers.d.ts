declare module "orbit-db-access-controllers" {
    ...
    export default class AccessControllers extends EventEmitter {
        ...
        static resolve (orbitdb: OrbitDB, manifestAddress: string, options: string): Promise<AccessController>

        static create (orbitdb: OrbitDB, type: string, options: any): Promise<string>
    }
}
